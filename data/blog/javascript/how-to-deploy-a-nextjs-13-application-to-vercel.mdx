...
shortDescription: You'll never believe how easy it is to deploy a Next.js application to Vercel. Seriously. It's a gamechanger.
tags: [JavaScript, NextJS, Vercel]
title: How to Deploy a Next.js Application to Vercel
tldr: You'll never believe how easy it is to deploy a Next.js application to Vercel. Seriously. It's a gamechanger.
