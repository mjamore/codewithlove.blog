...
<Image class='bordered-img' src='/images/blog/deploy-to-vercel/new-next-project.jpg' alt='Create a new Next.js project' width={700} height={100} />

On the next page, if you are creating a new project from a Vercel template, give your repository and click "Create".

<Image class='bordered-img' src='/images/blog/deploy-to-vercel/name-repository.jpg' alt='Name your new project' width={700} height={100} />
...
<Image class='bordered-img' src='/images/blog/deploy-to-vercel/started-deployment.jpg' alt='New Vercel deployment has started' width={700} height={100} />
...
<Image class='bordered-img' src='/images/blog/deploy-to-vercel/completed-deployment.jpg' alt='Vercel deployment has completed successfully' width={700} height={100} />
...
<Image class='bordered-img' src='/images/blog/deploy-to-vercel/visit-button.jpg' alt='View new Vercel deployment' width={700} height={100} />

### Wrap It Up

In just a matter of a couple minutes, you were able to create a new project from a starter template, connect it to your GitHub, and make it publically accessible on the internet. That's pretty amazing!
