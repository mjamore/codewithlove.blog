...
export default function Head() {
  const meta = {
    title: "Michael Amore's Uses Page | The Code With Love Web Development Blog",
    description: `A simple list of all of the different tools and technologies that I use on a daily basis.`,
