...
export default function ArticleCard({ author, authorImage, date, image, shortDescription, title, url }: ArticleMetaData) {
  return (
    <Link href={url} className={'relative rounded-articleCard bg-white text-black duration-300 hover:scale-101'}>
      ...
      <div className={'flex flex-col p-6'}>
        ...
        <p className={'max-w-prose'}>{shortDescription}</p>
