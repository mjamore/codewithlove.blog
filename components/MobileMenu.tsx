...
export default function MobileMenu() {
  ...
  return (
    <>
      ...
      {isMenuMounted && (
        <ul className={cn(styles.menu, 'absolute flex flex-col bg-gray-100 dark:bg-gray-900', isMenuRendered && styles.menuRendered)}>
          <li className='border-b border-gray-300 text-sm font-semibold text-gray-900 dark:border-gray-700 dark:text-gray-100' style={{ transitionDelay: '150ms' }}>
            <Link href='/' className='flex w-auto pb-4'>
              Home
            </Link>
          </li>
          <li className='border-b border-gray-300 text-sm font-semibold text-gray-900 dark:border-gray-700 dark:text-gray-100' style={{ transitionDelay: '250ms' }}>
            <Link href='/articles' className='flex w-auto pb-4'>
              Articles
            </Link>
          </li>
          <li className='border-b border-gray-300 text-sm font-semibold text-gray-900 dark:border-gray-700 dark:text-gray-100' style={{ transitionDelay: '275ms' }}>
